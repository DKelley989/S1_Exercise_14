...
// Func: Function to set up the style sheet switcher and insert form buttons to allow the user to switch between web view and page view
function setupStyles() {
    // Var: Create a link element for the page view styles
    ...
    // Var: Insert buttons for the style switcher
    ...
    pageButton.setAttribute("value", "Web View");
    ...
    // Var: Append an embedded style sheet to the document head
